...
void build_coacd(py::module &m)
{
    ...
    m.def("run_coacd", &coacd::CoACD, py::arg("mesh"), py::arg("mcts_node") = 20, py::arg("threshold") = 0.05,
            py::arg("max_convex_hull") = -1, py::arg("resolution") = 3000, py::arg("seed") = 0, py::arg("preprocess") = true,
