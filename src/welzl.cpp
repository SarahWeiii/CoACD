...
namespace coacd
{
    ...
    vec3d min_x = *std::min_element(P.begin(), P.end(), [](const vec3d& a, const vec3d& b) { return a[0] < b[0]; });
    vec3d max_x = *std::max_element(P.begin(), P.end(), [](const vec3d& a, const vec3d& b) { return a[0] < b[0]; });
    vec3d min_y = *std::min_element(P.begin(), P.end(), [](const vec3d& a, const vec3d& b) { return a[1] < b[1]; });
    vec3d max_y = *std::max_element(P.begin(), P.end(), [](const vec3d& a, const vec3d& b) { return a[1] < b[1]; });
    vec3d min_z = *std::min_element(P.begin(), P.end(), [](const vec3d& a, const vec3d& b) { return a[2] < b[2]; });
    vec3d max_z = *std::max_element(P.begin(), P.end(), [](const vec3d& a, const vec3d& b) { return a[2] < b[2]; });
